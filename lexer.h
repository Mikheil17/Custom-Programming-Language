...
#define SELF_PLUS   3014
#define SELF_MINUS  3015
#define SELF_MULTIPLY 3016
#define SELF_DIVIDE 3017
#define SELF_MOD    3018
// ---------------------------------------------------------------------------
// Useful abstractions
// ---------------------------------------------------------------------------
...
inline const char* tokName(Token t) {
  switch (t) {
    ...
    case CUSTOM:        return "CUSTOM_KEYWORD";      
    ...
    case SELF_MULTIPLY: return "SELF_MULTIPLY";
    case SELF_DIVIDE:   return "SELF_DIVIDE";
    case SELF_MOD:      return "SELF_MOD";
